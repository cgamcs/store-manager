            ...
            <Form>
              <div className="flex items-center gap-2 mb-3">
                <div className="flex flex-col gap-1">
                  <label htmlFor="name" className="text-gray-300">Nombre <span className="text-gray-500">*</span></label>
                  <input
                    type="text"
                    name="name"
                    id="name"
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="lastname" className="text-gray-300">Apellido <span className="text-gray-500">*</span></label>
                  <input
                    type="text"
                    name="lastname"
                    id="lastname"
